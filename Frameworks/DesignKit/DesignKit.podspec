...
Contains ui components for Design System.
  ...
  s.homepage         = 'https://github.com/samlaudev/DesignKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'samlaudev' => 'samlaudev@gmail.com' }
  s.source           = { :git => 'https://github.com/samlaudev/DesignKit.git', :tag => s.version.to_s }
